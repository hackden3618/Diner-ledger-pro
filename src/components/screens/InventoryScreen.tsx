...
export default function InventoryScreen() {
    ...
    return (
        <KeyboardAvoidingView behavior="padding" className="flex-1">
            {/* Search Header */}
            <View className="bg-card px-4 w-94 pt-4 pb-3 border-b border-border-light shadow-sm z-10">
                            ...
                            >
                                ...
                                <View className="p-5">
                                    ...
                                    <View className="flex-row items-center pt-2">
                                        <View
                                            className={`w-[46px] h-[46px] rounded-full border-[3px] items-center justify-center mr-3 ${isLow ? 'border-destructive' : 'border-primary'
                                                }`}
                                        >
